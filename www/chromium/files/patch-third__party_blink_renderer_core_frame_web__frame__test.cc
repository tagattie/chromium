--- third_party/blink/renderer/core/frame/web_frame_test.cc.orig	2021-12-14 11:45:12 UTC
+++ third_party/blink/renderer/core/frame/web_frame_test.cc
@@ -6077,7 +6077,7 @@ TEST_F(WebFrameTest, DISABLED_PositionForPointTest) {
...
@@ -6447,7 +6447,7 @@ TEST_P(CompositedSelectionBoundsTest, SVGBasic) {
