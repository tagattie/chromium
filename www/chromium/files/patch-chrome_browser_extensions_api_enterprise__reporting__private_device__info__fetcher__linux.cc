--- chrome/browser/extensions/api/enterprise_reporting_private/device_info_fetcher_linux.cc.orig	2020-10-07 16:38:38 UTC
...
+#if !defined(OS_BSD)
   ...
   stat("/", &info);
@@ -126,6 +129,7 @@ enterprise_reporting_private::SettingValue GetDiskEncr
...
@@ -164,7 +168,11 @@ DeviceInfoFetcherLinux::~DeviceInfoFetcherLinux() = de
