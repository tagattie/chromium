--- gpu/command_buffer/service/external_vk_image_backing.cc.orig	2020-10-07 16:38:46 UTC
...
@@ -582,7 +582,7 @@ std::unique_ptr<SharedImageRepresentationDawn>
...
@@ -601,7 +601,7 @@ ExternalVkImageBacking::ProduceDawn(SharedImageManager
...
+#else  // (!defined(OS_LINUX) && !defined(OS_BSD)) || !BUILDFLAG(USE_DAWN)
   ...
   return nullptr;
 #endif
@@ -614,7 +614,7 @@ GLuint ExternalVkImageBacking::ProduceGLTextureInterna
