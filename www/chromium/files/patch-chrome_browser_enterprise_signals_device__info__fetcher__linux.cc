--- chrome/browser/enterprise/signals/device_info_fetcher_linux.cc.orig	2021-12-07 05:33:19 UTC
...
@@ -112,6 +123,7 @@ SettingValue GetScreenlockSecured() {
...
+#else
   ...
   if (!reader.IsValid())
     return result;
@@ -160,6 +196,7 @@ std::vector<std::string> GetMacAddresses() {
                               &address);
