--- content/gpu/gpu_sandbox_hook_linux.cc.orig	2021-12-07 05:33:28 UTC
...
@@ -396,6 +402,7 @@ std::vector<BrokerFilePermission> FilePermissionsForGp
 }
...
@@ -428,6 +435,7 @@ void LoadArmGpuLibraries() {
