--- components/feature_engagement/public/feature_constants.cc.orig	2021-12-07 05:33:25 UTC
...
@@ -46,7 +46,7 @@ const base::Feature kIPHDesktopPwaInstallFeature{
...
@@ -225,12 +225,12 @@ const base::Feature kIPHDiscoverFeedHeaderFeature{
